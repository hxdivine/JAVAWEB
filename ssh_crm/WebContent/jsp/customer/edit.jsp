...
<BODY>
	<FORM id=form1 name=form1
		...
		<input type="hidden" name="cust_image" value="${customer.cust_image }"/>
					...
					<TD vAlign=top width="100%" bgColor=#ffffff>
						...
						<TABLE cellSpacing=0 cellPadding=5  border=0>
							<TR>
								...
								<td>客户级别 ：</td>
								<td>
									<select id="cust_level" style="WIDTH: 180px" maxLength=50 name="baseDictLevel.dict_id">
											<option value="${customer.baseDictLevel.dict_id}">${customer.baseDictLevel.dict_item_name}</option>
									</select>
								</td>
							</TR>
							...
							<TR>
								...
								<td>信息来源 ：</td>
								<td>
									<select id="cust_source" style="WIDTH: 180px" maxLength=50 name="baseDictSource.dict_id">
											<option value="${customer.baseDictSource.dict_id}">${customer.baseDictSource.dict_item_name}</option>
									</select>
								</td>
								<td>所属行业 ：</td>
								<td>
									<select id="cust_industry" style="WIDTH: 180px" maxLength=50 name="baseDictIndustry.dict_id">
											<option value="${customer.baseDictIndustry.dict_id}">${customer.baseDictIndustry.dict_item_name}</option>
									</select>
								</td>
							</TR>
							<TR>
							...
							<TR>
								...
								<td>文件上传：</td>
								<td>
									<input type="file" style="WIDTH: 180px" name="upload"/>
								</td>
							</TR>
							<%-- 
							<TR>
