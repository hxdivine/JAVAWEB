...
<SCRIPT language=javascript>
	...
	$(function(){
		...
		$.post("${pageContext.request.contextPath }/baseDict_findByTypeCode.action",{"dict_type_code":"002"},
			...
			$("#cust_source option[value='${model.baseDictSource.dict_id}']").pop("selected","selected");
		},"json");
		...
		$.post("${pageContext.request.contextPath }/baseDict_findByTypeCode.action",{"dict_type_code":"006"},
			...
			$("#cust_level option[value='${model.baseDictLevel.dict_id}']").pop("selected","selected");
		},"json");
		...
		$.post("${pageContext.request.contextPath }/baseDict_findByTypeCode.action",{"dict_type_code":"001"},
			...
			$("#cust_industry option[value='${model.baseDictIndustry.dict_id}']").pop("selected","selected");
		},"json");
	});
</SCRIPT>
									...
									<TD><SPAN id=pagelink>
											<DIV
												...
												<s:iterator var="i" begin="1" end="totalPage">
													...
													<s:else>
														<a hrf="javascript:to_page(<s:property value="#i"/>)"><s:property value="#i"/></a>
													</s:else>
												</s:iterator>
												...
												<input type="button" name="currPage" value="Go" onclick="to_page()"/>
											</DIV>
									</SPAN></TD>
								</TR>
							</TBODY>
